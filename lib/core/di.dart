...
import 'package:pureservers/repositories/invoice/invoice_repository_impl.dart';
...
Future<void> configureDependence() async {
  ...
  if (kReleaseMode || useServer) {
    getIt.registerFactory<AuthRepository>(
      () => AuthRepositoryImpl(getIt()),
    );
    getIt.registerFactory<ServerRepository>(
      () => ServerRepositoryImpl(getIt()),
    );
    getIt.registerFactory<TariffRepository>(
      () => TariffRepositoryImpl(getIt()),
    );
    getIt.registerFactory<OsRepository>(
      () => OsRepositoryImpl(getIt()),
    );
